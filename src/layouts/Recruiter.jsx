...
class Recruiter extends Component {
  ...
  render() {
    ...
    return <>{(this.state.userType) !== "recruiter" ? window.location.href = "../" + this.state.userType + "/dashboard" : <>
      <AdminNavbar
        ...
        <div className="page-content">
          <div className="container-fluid">
            <div className="main-content" ref="mainContent" id="panel" onClick={this.hideSideBar}>
              <Switch>{this.getRoutes(routes)} <Redirect from="*" to="/recruiter/dashboard" /></Switch>
