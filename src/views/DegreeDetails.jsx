...
class WorkAuthorizationDetails extends Component { 
  ...
  createNewRecords = (event) => {
    ...
    fData.append("configType", "degree");
  ...
  loadAllDepartments() {
    axios.get(serverAPI + "getConfigList",{params:{ sess_id:cookies.get("c_csrftoken"),search:"degree"}})
      .then(({ data }) => {
            ...
            <div className="row">
              <div className="col">
                <div className="col-sm-6 float-left">
                  <h4 className="page-title">Degree</h4>
                </div>
            ...
            <Table className="align-items-center table-flush" responsive>
              ...
              {this.state.departmentList.length != 0 ? (
                <tfoot>
                  ...
                  {(this.state.numberOfRecords >= 10) ? <div className="pt-2 mt-2 justify-content-end mb-0 pagination">
          ...
          <form className="p-4">
            <div >
              <div>
                ...
                <div className=" col-md-10 float-left pr-0">
                  <div className="form-group row">
                      <label for="example-text-input" className="col-sm-4 float-left col-form-label text-left"> Name</label>
                      <div className="col-sm-8">
...
export default WorkAuthorizationDetails;