...
import ProfileBoxList from "../../views/Misc/ProfileBoxList";
...
const DATE_OPTIONS =  { year: '2-digit', month: 'short', day: 'numeric',hour:'2-digit',minute:'2-digit' };// weekday: 'short',

const DATE_OPTIONS2 =  { year: '2-digit', month: 'short', day: 'narrow',hour:'2-digit',minute:'2-digit' };// weekday: 'short',

const DATE_OPTION3 = { day: '2-digit', year: 'numeric', month: 'short' };
                                        ...
                                        <div className="col-sm-12 pt-2  pl-0 ml-0">
                                            <ul className="jpQViewList">
                                                ...
                                                <li>
                                                    ...
                                                    <div className="jphLabel-2" style={{width:"125px",lineHeight:"15px"}}>{this.state.jobDetails.payRateCurrency} {this.state.jobDetails.payRateMinValue} to {this.state.jobDetails.payRateMaxValue} {this.state.jobDetails.payRateFrequency} {this.state.jobDetails.payRateTaxTerms} </div>
                                                </li>
                                                <li style={{paddingRight:'15px'}}>
                                                    <div className="jphLabel-1">Created On </div>
                                                    <div className="jphLabel-2">{new Date(this.state.jobDetails.createdDate).toLocaleDateString("en-IN",DATE_OPTION3)}</div>
                                                </li>
                                                <li style={{paddingRight:'15px'}}>
                        ...
                        <div className="col p-0">
                            <Card className="p-2">
                                ...
                                <div className="tab-content">
                                    <div className={`tab-pane pt-3 ${this.state.activeTab == 'jobdetails' ? 'active' : ''}`} id="home" role="tabpanel" style={{paddingLeft:"3px"}}>
                                        ...
                                        <div className="p-1 card-body" >
                                            <div className="col-sm-12">
                                                <div className="col-sm-4 float-left pl-0" style={{lineHeight:"13px"}}>
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <span className="formValue">{this.state.jobDetails.endDate!=""?new Date(this.state.jobDetails.endDate).toLocaleDateString("en-IN",DATE_OPTION3):""}</span>
                                                    </div>
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <span className="formValue">{this.state.jobDetails.careerPortalPublishedDate!=""?new Date(this.state.jobDetails.careerPortalPublishedDate).toLocaleDateString("en-IN",DATE_OPTION3):""}</span>
                                                    </div>
                                                </div>


                                                <div className="col-sm-4 float-left"  style={{lineHeight:"13px"}}>
                                                 {/*  <div className="form-group">
                                                ...
                                                <div className="col-sm-4 float-left"  style={{lineHeight:"13px"}}>
                                                    <div className="form-group">
                                                        ...
                                                        <span className="formValue">{this.state.jobDetails.jobStartDate!=""?new Date(this.state.jobDetails.jobStartDate).toLocaleDateString("en-IN",DATE_OPTION3):""}</span>
                                                    </div>
