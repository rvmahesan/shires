...
class WorkAuthorizationDetails extends Component { 
  ...
  createNewRecords = (event) => {
    ...
    fData.append("configType", "workauthorization");
  ...
  loadAllDepartments() {
    axios.get(serverAPI + "getConfigList",{params:{ sess_id:cookies.get("c_csrftoken"),search:"workauthorization"}})
      .then(({ data }) => {
            ...
            <div className="row">
              <div className="col">
                <div className="col-sm-6 float-left">
                  <h4 className="page-title">Workauthorization</h4>
                </div>
