...
class IndustryDetails extends Component {
  ...
  createNewRecords = (event) => {
    ...
    fData.append("configType", "industry");
  ...
  loadAllDepartments() {
    axios.get(serverAPI + "getConfigList",{params:{ sess_id:cookies.get("c_csrftoken"),search:"industry"}})
      .then(({ data }) => {
          ...
          <form className="p-4">
            <div >
              <div>
                ...
                <div className=" col-md-10 float-left pr-0">
                  <div className="form-group row">
                      <label for="example-text-input" className="col-sm-4 float-left col-form-label text-left">Industry Name</label>
                      <div className="col-sm-8">
