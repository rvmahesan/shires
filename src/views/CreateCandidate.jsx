...
import { candidatePostUrl, candidateResumeUpdateUrl, style } from "../variables/Variables.jsx";
               ...
               <Row>
                  ...
                  <Col lg="12" xl="12">
                     ...
                     <div className="file-box-content">
                        ...
                        <input type="file"  onChange={this.handleUpload} name="file" id="input-file-now" className="dropify"/>                                                       
                        </div>
                     </div>
                     <div className="mt-3">
                  <button type="button" onClick={this.completeUpload} className="pull-left mr-2 btn btn-primary btn-square btn-outline-dashed waves-effect waves-light">
                                 <span className="btn-inner--icon"><i className="fa fa-upload"></i></span>Upload</button>
                  <a href={'../' + userType + '/candidates'}
                        className="btn btn-secondary btn-square btn-outline-dashed waves-effect waves-light "
                     >Back</a>
                     </div>
                  </center>
