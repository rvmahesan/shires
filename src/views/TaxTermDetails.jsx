...
class TaxTermDetails extends Component {
  ...
  createNewRecords = (event) => {
    ...
    fData.append("configType", "taxterms");
  ...
  loadAllDepartments() {
    axios.get(serverAPI + "getConfigList",{params:{ sess_id:cookies.get("c_csrftoken"),search:"taxterms"}})
      .then(({ data }) => {
            ...
            <div className="row">
              <div className="col">
                <div className="col-sm-6 float-left">
                  <h4 className="page-title">Taxterms</h4>
                </div>
