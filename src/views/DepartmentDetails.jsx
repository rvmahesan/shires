...
class DepartmentDetails extends Component {
  ...
  createNewRecords = (event) => {
    ...
    fData.append("configType", "department");
  ...
  loadAllDepartments() {
    axios.get(serverAPI + "getConfigList",{params:{ sess_id:cookies.get("c_csrftoken"),search:"department"}})
      .then(({ data }) => {
          ...
          <form className="p-4">
            <div >
              <div>
                ...
                <div className=" col-md-10 float-left pr-0">
                  <div className="form-group row">
                      <label for="example-text-input" className="col-sm-4 float-left col-form-label text-left">Department Name</label>
                      <div className="col-sm-8">
