...
//axios.defaults.headers.common['Authorization'] = 'Token '+cookies.get('csrftoken')
...
class VendorRequirmentDetails extends Component{
        ...
        axios.post(apiUrl+"vendorSubmitOldCandidate",fData,config).then(function(res){
            alert(res.statusResponse);
              if(res.statusResponse){
                  ...
                  this.setState({oldProfileSubmitModal:false})
               }else{
                  Swal.fire({
                     icon: 'error',
                     title: 'Oops...',
        ...
        <CardHeader className="border-1 pr-1">
            ...
            <Button title="Submit new candidate" className=" pull-left btn bg-blue-primary" onClick={()=>{ this.setState({submitNewCandidate:true,submitOldCandidate:false});if(this.state.fnameRef.current !== null) this.state.fnameRef.current.focus(); }}>
                    ...
                    <Button title="select from profiles"  className="pull-left btn bg-blue-secondary"  onClick={()=>{ this.setState({submitOldCandidate:true,submitNewCandidate:false}); }}>
                        <span className="btn-inner--icon mr-1"><i className="fas fa-user-astronaut" ></i></span><span className="btn-inner--text">Submit Existing</span>
                    </Button>
...
{this.state.jobDetails.requirementSecurityClearance==="true"?<span className="label text-bold" htmlFor="requirementSecurityClearance">  - <strong>Security Clearance</strong> </span>:""}
    ...
    <CardFooter >
        ...
        <Button title="Submit new candidate" className=" pull-left btn bg-blue-primary" onClick={()=>{ this.setState({submitNewCandidate:true,submitOldCandidate:false});if(this.state.fnameRef.current !== null) this.state.fnameRef.current.focus(); }}>
                    ...
                    <Button title="Submit Existing"  className="ml-2 pull-left btn bg-blue-secondary" onClick={()=>{ this.setState({submitOldCandidate:true,submitNewCandidate:false}); }}>
                        <span className="btn-inner--icon mr-1"><i className="fas fa-user-astronaut" ></i></span><span className="btn-inner--text">Submit Existing</span>
                    </Button>
                     ...
                     {this.state.oldcandidateDetails!==""?<>{(this.state.searchCandidateDetails.length)>=1?<>{this.state.searchCandidateDetails.map(function(obj,index){
                           ...
                           <div className="card-body">  
                               ...
                               <div className="d-flex justify-content-between">                                        
                                   ...
                                   <small className="font-weight-semibold font-13 align-self-center"></small>
                               </div>
                               ...
                               <div className="mt-4  justify-content-between d-none">
                           ...
                           <Button title="Submit new candidate" className=" pull-left btn bg-blue-primary" onClick={(e)=>{
                               thisObj.setState({oldProfileSubmitModal:true,oldcandidateId:obj.id});
        ...
        <Modal isOpen={this.state.oldProfileSubmitModal}>
            ...
            <ModalFooter>
               ...
               <button type="submit" onClick={(e)=>{this.startSubmission(this.state.oldcandidateId,this.state.jobDetails.id);}} title="Upload new resume"  className="pull-left btn btn-primary btn-square btn-outline-dashed waves-effect waves-light">
...
export default VendorRequirmentDetails;